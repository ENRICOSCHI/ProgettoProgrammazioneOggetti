...
namespace GiocoTestualeEsame.stanze
{
    public class ElencoStanze
    {
        ...
        public static Stanza salaGiochi { get; } = new Stanza("sala giochi", "se nella sala giochi, però non si vede molto, è tutta buglia perchè è saltata la corrente e non è quindi possibile giocare a nessun arcade.");
